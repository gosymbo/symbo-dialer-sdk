...
class SymboDialerClient {
  ...
  /**
   * Sign the rep in silently with a trusted auth token your server signed.
   *
  ...
  signIn(options = {}) {
    if (!options.token) {
      return Promise.reject(invalid('signIn needs the trusted auth token your server signed.'))
    }
